...
public class PagedImpl extends PresenterImpl<PagedContract.View>
    implements PagedContract.Presenter {

  private Context mContext;
  private PagedContract.Repository mPostRepository;
  ...
  PagedImpl(
      ...
      PagedContract.Repository postRepository,
  ...
  @Override
  public void attach(PagedContract.View view) {
    super.attach(view);
    view().setUpToolbar();
    view().init();
    getPosts();
